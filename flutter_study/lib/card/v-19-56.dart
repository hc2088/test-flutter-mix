      ...
      child: Transform.scale(
        ...
        child: Transform.rotate(
          ...
          child: Transform.translate(
            offset: Offset(-angle * 20 * (1 - tDown), 0), // ✅ 角度补偿平滑收尾
            child: child,
          ),
        ),
      ),
...
class _CardContent extends StatefulWidget {
  ...
  final double width;
  final bool isTop;
  const _CardContent({required this.item, required this.width, required this.isTop});
  @override
      ...
      children: [
        ClipRRect(
          ...
          child: CachedNetworkImage(
            ...
            placeholder: (_, __) => Container(color: Colors.grey.shade800.withOpacity(0.2)),
          ),
        ),
        if (imageLoaded)
          Positioned.fill(
