...
#import "NSObject+FfiExtented.h"

@implementation NSObject (FfiExtented)
...
//    }
    for (id tmpObject = object; (id)tmpObject != [FfiEndMark end]; tmpObject = va_arg(args, id)) {
        // 防止越界
